...
local function LoadInterfaceFeaturesPanel(sWindow)
    ...
    p:AddOption(L["Show set bonus count"], L["Shows how many pieces of your equipped item set you are wearing as a tile in the attributes list."], {getterSetter = "CHARACTER_SHOW_SET_BONUS", callback = function() if GW.UpdateCharacterStats then GW.UpdateCharacterStats() end end, groupHeaderName = L["UI Windows"], hidden = not GW.Retail, dependence = {["USE_CHARACTER_WINDOW"] = true}})
